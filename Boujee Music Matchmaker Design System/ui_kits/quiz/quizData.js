...
var BANDS = {
  UTSD: { name: 'Uptown Showdown', style: 'Flagship show band — high-energy 80s/90s, disco, soul & R&B singalongs', video: 'https://youtu.be/Y0oHz4SKayU' },
  VS: { name: 'The Velvet Saints', style: 'Smaller line-up, high-energy indie/rock edge', video: 'https://youtu.be/2psnhMdF_X0' },
  RS: { name: 'The Rock & Strollers', style: 'Roaming acoustic, chilled-to-building, guest-to-guest singalongs', video: 'https://youtu.be/Rrp-nPo6ULA' },
  MH: { name: 'Miles High', style: 'Jazz/swing, sophisticated ceremony, drinks & dinner music', video: 'https://youtu.be/BjbAbgVjQfQ' },
};
var EVENING_SONGS = [
